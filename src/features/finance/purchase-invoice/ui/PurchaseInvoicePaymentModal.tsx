  ...
  return (
    <>
      ...
      <ConfirmModal
        ...
        message={
          <div>
            Bạn có chắc chắn muốn thanh toán số tiền <strong>{formatCurrency(payAmount)}</strong> cho hóa đơn mua hàng này không? Dòng tiền chi sẽ được tạo và ghi nhận hoàn tất ngay lập tức.
          </div>
        }
